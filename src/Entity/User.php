...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    /**
     * @ORM\OneToOne(targetEntity=userAddress::class, cascade={"persist", "remove"})
     */
    private $lastAddress;
    ...
    public function getLastAddress(): ?userAddress
    {
        return $this->lastAddress;
    }

    public function setLastAddress(?userAddress $lastAddress): self
    {
